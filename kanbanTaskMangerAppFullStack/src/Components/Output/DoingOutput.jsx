          ...
          {tasks.map((task, index) => {
            ...
            return (
              ...
              onClick={() => {
                ...
                key={index}
                className="bg-white dark:bg-lightBlack2 dark:text-white p-4 shadow-xl mb-5 rounded-md w-[280px] cursor-pointer"
              >
